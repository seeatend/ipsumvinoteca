                    ...
                    <div class="box-header">
                        <div class="row">
                            <div class="col-md-10 col-sm-9">
                                <h3 class="box-title mt-10">All Booking</h3>
...
<?php } ?>
                    ...
                    <div class="box-body">
                        <table id="" class="table table-bordered table-hover display nowrap margin-top-10 table-responsive example1" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php
                                if (!empty($arronlinebooking)) {
                                    foreach ($arronlinebooking as $arronlinebookingobj) {
                                        ?>
                                        <tr>
                                            <th>
                                                <div class="controls">
                                                    <label class="custom-control custom-checkbox">
                                                    <input type="checkbox" required value="<?php echo $arronlinebookingobj->id; ?> " name="single_checkbox" class="custom-control-input checkItemdelete"> <span class="custom-control-indicator"></span> </label>
                                                </div> 
                                            </th>
                                            <td><a href="<?php echo base_url('admin/ipsum-onlinebooking-detail' . '/' . $arronlinebookingobj->id); ?>"><?php echo  $arronlinebookingobj->customer_name  ; ?></a></td>
<!--                                              <td><span class="label label-<?php echo $arrgetcatobj->status==1?'success':'danger';?>"><?php
                                                    ...
                                                    ?></span></td>-->
                                            <td><?php echo $arronlinebookingobj->customer_email  ; ?></td>
                                            <td><?php echo  $arronlinebookingobj->customer_phone   ; ?></td>
                                            <td>
...
<!--                                                <a href="<?php echo base_url('admin/yoga-detail' . '/' . $arrgetcatobj->id); ?>" > <button class="btn btn-social-icon btn-circle"><i class="fa fa-eye"></i></button></a>-->
                                                <button class="btn btn-social-icon btn-circle delyogacenter" data-toggle="modal" data-target="#modal-primary" value="<?= $arronlinebookingobj->id; ?>" data-href="<?php echo base_url('admin/ipsum-onlinebooking-delete') . '/' . $arronlinebookingobj->id; ?>"><i class="glyphicon glyphicon-trash"></i></button>
