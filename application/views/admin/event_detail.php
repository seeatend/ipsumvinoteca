...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h4>
            <?php echo !empty($eventDetail->title) ? $eventDetail->title : ''; ?> 's Details
        </h4>
        <ol class="breadcrumb">
            <!--<li class="breadcrumb-item"><a href="<?php echo base_url('admin/dashboard'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>-->
            <li class="breadcrumb-item"><a href="<?php echo base_url('admin/ipsum-event-view'); ?>">Online Events</a></li>
            <li class="breadcrumb-item active">Online Event Detail</li>
        </ol>
    </section>
                        ...
                        <div class="<?php echo empty($_GET) ? "active" : '' ?> tab-pane" id="timeline">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="label-control" style="font-weight:bold;"> Event Title :</label> 
                                            <p style="display: inline-block;margin-left: 20px;"> <?php echo !empty($eventDetail->title ) ? $eventDetail->title : ''; ?></p>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="label-control" style="font-weight:bold;"> Event Date :</label> 
                                            <p style="display: inline-block;margin-left: 20px;">  <?php echo !empty($eventDetail->date ) ? $eventDetail->date  : ''; ?></p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label class="label-control" style="font-weight:bold;"> Event Link :</label>
                                            <p style="display: inline-block;margin-left: 20px;"><?php echo !empty($eventDetail->link) ? $eventDetail->link : ''; ?></p>
                                        </div>
                                    </div>
<!--                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="label-control" style="font-weight:bold;"> Country :</label><br> 
                                            <p> <?php echo !empty($eventDetail-> 	status ) ? $eventDetail-> 	status  : ''; ?></p>
                                        </div>
